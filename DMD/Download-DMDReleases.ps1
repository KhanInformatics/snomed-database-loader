# Download DM+D Releases from TRUD
# Save this as Download-DMDReleases.ps1
...
# Define the DM+D items you want to download.
# These are the correct TRUD item numbers for actual DM+D XML data
# - NHSBSA dm+d: Item number 24 (main dm+d data in XML format)
# - NHSBSA dm+d supplementary: Item number 25 (bonus/supplementary data)
$items = @(
    @{ Name = "NHSBSA_DM+D_Main"; ItemNumber = "24" },
    @{ Name = "NHSBSA_DM+D_Supplementary"; ItemNumber = "25" }
)
...
Write-Host "`n✅ All DM+D releases downloaded, extracted, and moved to CurrentReleases."
Write-Host "Next step: Run Process-DMDData.ps1 to process the XML files and generate import scripts."